        ...
        <motion.div className="fixed md:hidden bottom-0 left-0 right-0 h-[100vh] mb-24 bg-black border-b border-neutral-800 text-zinc-300 justify-between flex-col z-20">
            ...
            <div className="flex p-8 items-center flex-col">
                <div className="flex flex-row gap-16">
                    <a className="text-zinc-300 hover:text-white transition-all" target="_blank" href="https://github.com/oonis" rel="noopener noreferrer">
                        <FiGithub className="text-3xl"/>
                    </a>
                    <a className="text-zinc-300 hover:text-white transition-all" target="_blank" href="https://twitter.com/willsc8forwings" rel="noopener noreferrer">
